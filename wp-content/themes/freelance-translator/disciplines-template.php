<?php
/*
* Template Name: Disciplines template
*/
...
<section class="main-section main-section--big main-section--disciplines">
	<h2 class="main-section__title main-section__title--big">Disciplines</h2>
</section>
...
<div id="app">
	<template>
		<info-table :action="'get_disciplines'" :big="true"></info-table>
	</template>
	<!-- <script
