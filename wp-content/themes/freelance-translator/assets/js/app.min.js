...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ langPagesBg)
/* harmony export */ });
function langPagesBg() {
  window.addEventListener('DOMContentLoaded', () => {
    const wrapper = document.querySelector('.bg-wrapper__img'),
          img = document.querySelector('.bg-wrapper__img img');
...
/* harmony import */ var _modules_langPagesbg_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/langPagesbg.js */ "./src/js/modules/langPagesbg.js");
...
try {
  (0,_modules_langPagesbg_js__WEBPACK_IMPORTED_MODULE_4__["default"])();
} catch (error) {
  console.warn();
}
})();
